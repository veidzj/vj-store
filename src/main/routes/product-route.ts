...
import { GetLatestProductsControllerFactory, GetProductBySlugControllerFactory, GetProductsByCategoryControllerFactory, GetProductsWithDiscountControllerFactory } from '@/main/factories/controllers/static/product'
...
export default (router: Router): void => {
  ...
  router.get('/product/latest', ExpressRouteAdapter.adapt(GetLatestProductsControllerFactory.makeGetLatestProductsControllerFactory()))
}
